...
module.exports = class ExplainPointsCommand extends Command {
    constructor(client) {
        super(client, {
            ...
            usage: 'explainpoints',
            description: 'Explains the various aspects about Ironman points and crown systems.',
    ...
    run(message) {
        ...
        const { message_points: messagePoints, command_points: commandPoints, voice_points: voicePoints } = message.client.db.settings.selectPoints.get(message.guild.id);
